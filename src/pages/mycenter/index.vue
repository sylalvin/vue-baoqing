    ...
    <div class="container-fuild mt-3 mb-5">
      <div class="row">
        <div class="col-md-2 offset-md-1 col-12 text-left">
          <ul>
            <li class="inner-nav">
              <router-link to="/mycenter/info" tag="span">基本信息</router-link>
            </li>
            <li class="inner-nav">
              <router-link to="/mycenter/detail" tag="span">会籍详情</router-link>
            </li>
            <li class="inner-nav">
              <router-link to="/mycenter/update" tag="span">密码安全</router-link>
            </li>
          </ul>
        </div>
